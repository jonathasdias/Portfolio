...
const Header = () => {
    ...
    return ( 
        <header className={`h-28 w-full md:text-lg px-4 text-blue-700 transition-all duration-300 flex flex-col sm:flex-row justify-center sm:justify-between items-center gap-y-2 z-10
        ...
        ${isVisible ? "bg-black" : "bg-transparent"}`}>
            ...
            <nav className="space-x-2 font-bold">
                <NavLink to="/" className="aria-[current=page]:text-blue-400 hover:text-blue-400 py-2 px-4 rounded-lg">Sobre</NavLink>
                <NavLink to="/projects" className="aria-[current=page]:text-blue-400 hover:text-blue-400 py-2 px-4 rounded-lg">Projetos</NavLink>
                <NavLink to="/curriculo" className="aria-[current=page]:text-blue-400 hover:text-blue-400 py-2 px-4 rounded-lg">Curriculo</NavLink>
            </nav>
        </header>
     );
}
